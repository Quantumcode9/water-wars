...
const AirQualityIndex: React.FC<AirQualityIndexProps> = ({ airQuality, onClick }) => {
if (!airQuality) {
    return null;
}
...
return (
    <div onClick={onClick} className="cursor-pointer hover:bg-gray-200 hover:shadow-lg transition duration-300 ease-in-out">
    <DashboardCard
        title="Air Quality"
